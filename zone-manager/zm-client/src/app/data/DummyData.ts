...
import {
  ...
  CARREFOUR_CRAIOVITA_COMMERCIAL_ZONE,
  CEZ_BUISNESS_ZONE,
  CORNITOIU_PARK_ZONE,
  CRAIOVITA_PARK_PROMENADA_PARK_ZONE,
  DEPOU_RAT_ADMINISTRATION_ZONE,
  FABRICA_HEINEKEN_INDUSTRIAL_ZONE,
  FABRICA_SOFTRONIC_INDUSTRIAL_ZONE,
  JUMBO_COMMERCIAL_ZONE,
...
export const SECTORS: Sector[] = [
  new Sector('1', 'Zona North-West', [
    new Neighborhood("1b", "Craiovita", "1", [
      ...
      new UrbanZone("1b3", "Carrefour Craiovita", UrbanZoneType.COMMERCIAL, "1b", [], undefined, CARREFOUR_CRAIOVITA_COMMERCIAL_ZONE),
      new UrbanZone("1b4", "Scoala Generala Elena Farago", UrbanZoneType.EDUCATIONAL, "1b", [], undefined, SC_ELENA_FARAGO_CRAIOVITA_EDUCATIONAL_ZONE),
      new Complex("1b5", "Craiovita Shopping Plazza", "1b", [
        new UrbanZone("1b5a", "Biserica Sf. Ioan Sebastian", UrbanZoneType.CULTURAL, "1b1", [
        ...
        new UrbanZone("1b5b", "Bloc B1", UrbanZoneType.RESIDENTIAL, "1b1", [
        ...
        new UrbanZone("1b5c", "Bloc B2", UrbanZoneType.RESIDENTIAL, "1b1", [], undefined, BLOC_2_PIATA_MARE_RESIDENTIAL_ZONE),
        new UrbanZone("1b5d", "Bloc B3", UrbanZoneType.RESIDENTIAL, "1b1", [], undefined, BLOC_3_PIATA_MARE_RESIDENTIAL_ZONE),
        new UrbanZone("1b5e", "Bloc B4", UrbanZoneType.RESIDENTIAL, "1b1", [], undefined, BLOC_4_PIATA_MARE_RESIDENTIAL_ZONE),
        new UrbanZone("1b5f", "Parculet Piata Mare", UrbanZoneType.PARK, "1b1", [], undefined, PIATA_MARE_PARK_ZONE),
      ], undefined, PIATA_CRAIOVITA_COMPLEX),
      new Complex("1b6", "Orizont", "1b", [
        new UrbanZone("1b6a", "Bloc I5", UrbanZoneType.RESIDENTIAL, "1b1", [
        ...
        new UrbanZone("1b6b", "Frizerie", UrbanZoneType.COMMERCIAL, "1b1", [
        ...
        new UrbanZone("1b6c", "Magazin la Scari", UrbanZoneType.COMMERCIAL, "1b1", []),
      ], undefined, ORIZONT_COMPLEX),
      new UrbanZone("1b7", "Cornitoiu Park", UrbanZoneType.PARK, "1b", [], undefined, CORNITOIU_PARK_ZONE),
      new UrbanZone("1b8", "Cornitoiu Park", UrbanZoneType.PARK, "1b", [], undefined, CRAIOVITA_PARK_PROMENADA_PARK_ZONE),
    ...
    new Neighborhood("1f", "Zona Industrial Cernele", "1", [
      new UrbanZone("1f1", "Fabrica de Bere Heineken", UrbanZoneType.INDUSTRIAL, "1f", [], undefined, FABRICA_HEINEKEN_INDUSTRIAL_ZONE),
      new UrbanZone("1f2", "Fabrica Softronic", UrbanZoneType.INDUSTRIAL, "1f", [], undefined, FABRICA_SOFTRONIC_INDUSTRIAL_ZONE),
      new UrbanZone("1f3", "Jumbo", UrbanZoneType.COMMERCIAL, "1f", [], undefined, JUMBO_COMMERCIAL_ZONE),
      new UrbanZone("1f4", "CEZ", UrbanZoneType.BUSINESS, "1f", [], undefined, CEZ_BUISNESS_ZONE),
      new UrbanZone("1f5", "Depoul Rat pt Autobuze", UrbanZoneType.ADMINISTRATIVE, "1f", [], undefined, RAT_ADMINISTRATION_ZONE),
      new UrbanZone("1f6", "Depoul Rat pt Tramvaie", UrbanZoneType.ADMINISTRATIVE, "1f", [], undefined, DEPOU_RAT_ADMINISTRATION_ZONE),
